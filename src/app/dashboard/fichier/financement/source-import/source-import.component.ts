...
export class SourceImportComponent implements OnInit {
  ...
  message: String = '';
  dataNumber = 0;
  typeSource: TypeSourceFinancement[];
  constructor(private sourcrService: SourceFinancementService, private router: Router, private utils: UtilsService, private typeSourceFinancementService: TypeSourceFinancementService) { }

  ngOnInit() {
    this.typeSourceFinancementService.getTypeSourceFinancementList()
