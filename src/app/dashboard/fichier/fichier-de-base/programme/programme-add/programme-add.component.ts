...
export class ProgrammeAddComponent implements OnInit {
  ...
  constructor(private  programmeService: ProgrammeService, private utilService: UtilsService,
              private exerciceService: ExercieService, private router: Router) { }
  ...
  onSubmit(form: NgForm) {
    ...
    console.log('le libellé est ' + form.value['libelle']);
    console.log('le poids est ' + form.value['poids']);
