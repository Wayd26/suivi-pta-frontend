...
export class SuiviTacheService {
  ...
  createSuiviTache(activite: string, tache: string, dateDebut: Date, dateFin: Date, montant: number, poids: number) {
    const data = {
      _activite: activite,
      _tache: tache,
    ...
    return this.httpClient.post(BASE_URL + 'administrateurs/1/taches/suivre', data, this.options);
  }
  updateSuiviTache(activite: string, tache: string, dateDebut: Date, dateFin: Date, montant: number, poids: number, id: number) {
    ...
    return this.httpClient.post(BASE_URL + 'administrateurs/1/modifier/suivre/' + id, data, this.options);
  }
